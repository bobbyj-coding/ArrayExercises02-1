...
let unshiftGear = cargoHold.unshift(1138);
console.log(cargoHold);

let pushPull = cargoHold.push("20 meters");
console.log(cargoHold);

//e) Use a template literal to print the final array and its length.

let commaSplit = cargoHold.split(',');

console.log(`Our cargo hold contains all of the following: ${commaSplit}. It contains a list of ${cargoHold.length} unique items.`);